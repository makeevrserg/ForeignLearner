...
public class FragmentFindForeignToWord extends Fragment {
    Options mOptions;
    Button[] buttonAnswer;
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        mContext = getContext();
        mOptions = new Options(requireActivity(),getContext());
        ...
        imageButtonHintWord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mOptions.ShowToastHintWord(view,getLayoutInflater(), Arrays.toString(correctWord.translation).trim().replace("[","").replace("]",""));
            }
        });
